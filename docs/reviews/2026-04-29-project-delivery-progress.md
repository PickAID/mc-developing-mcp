...
- Latest full verification: `pnpm test` passed with 108 test files and 342 tests
...
- current progress update: resource-pack profile separation for assets-only evidence
...
- official resource-pack format catalog and versioned asset validation
