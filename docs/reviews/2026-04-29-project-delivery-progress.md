...
- Latest full verification: `pnpm test` passed with 103 test files and 319 tests
...
- current progress update: compact local datapack supported format ranges in version profiles
