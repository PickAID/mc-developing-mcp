...
- Latest full verification: `pnpm test` passed with 108 test files and 344 tests
...
- current progress update: official resource-pack profile catalog through MCP evidence
