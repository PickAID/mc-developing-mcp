...
- Latest full verification: `pnpm test` passed with 103 test files and 317 tests
...
- current progress update: compact local datapack version profile and support-boundary reporting
