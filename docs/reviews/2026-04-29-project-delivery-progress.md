...
- Latest full verification: `pnpm test` passed with 103 test files and 322 tests
...
- current progress update: official datapack release profile catalog from `1.18.2` through `26.1.2`
