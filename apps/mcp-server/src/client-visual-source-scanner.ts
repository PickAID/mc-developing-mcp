...
const PATTERNS: Record<
  Exclude<ClientVisualSourceEvidenceKind, "resourceLocationReferences">,
  ReadonlyArray<{ symbol: string; pattern: RegExp }>
> = {
  candidateRegistries: [
  ...
  candidateRendererBindings: [
    {
      symbol: "registerBlockEntityRenderer",
      pattern: /\bregisterBlockEntityRenderer\b/
    },
    {
      symbol: "BlockEntityRenderers.register",
      pattern: /\bBlockEntityRenderers\.register\b/
    },
    ...
    { symbol: "registerEntityRenderer", pattern: /\bregisterEntityRenderer\b/ },
    {
      ...
      pattern: /\bEntityRendererRegistry\.register\b/
    }
  ],
  candidateScreenRegistrations: [
...
function scanFile(input: {
  ...
  for (const [kind, patterns] of Object.entries(PATTERNS) as Array<
    [
      Exclude<ClientVisualSourceEvidenceKind, "resourceLocationReferences">,
      ReadonlyArray<{ symbol: string; pattern: RegExp }>
    ]
